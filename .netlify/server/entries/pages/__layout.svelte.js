...
const Contact = (0, import_index_1259f1f6.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"contact-component svelte-qsahef"}"><section><h2>Contact</h2>
		...
		<form name="${"contact"}" method="${"POST"}" data-netlify="${"true"}"><div class="${"fields"}"><div class="${"field half"}"><p class="${"contact-form"}">Name (required)</p>
					<input type="${"text"}" name="${"name"}" id="${"name"}" required></div>
				<div class="${"field half"}"><p class="${"contact-form"}">Email (required)</p>
					<input type="${"email"}" name="${"email"}" id="${"email"}" required></div>
				<div class="${"field"}"><p class="${"contact-form"}">Message</p>
					<textarea name="${"message"}" id="${"message"}" rows="${"4"}" required></textarea></div>
